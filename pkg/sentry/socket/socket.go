...
// newPacketInfo converts IPPacketInfo from tcpip format to Linux format.
func newPacketInfo(packetInfo tcpip.IPPacketInfo) linux.ControlMessageIPPacketInfo {
...
func NewIPControlMessagges(cmgs tcpip.ControlMessages) IPControlMessages {
	return IPControlMessages{
		...
		PacketInfo:      newPacketInfo(cmgs.PacketInfo),
	}
}

// IPControlMessages contains socket control messages for IP sockets.
// This can contain Linux specific structures.
//
// +stateify savable
